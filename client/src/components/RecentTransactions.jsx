...
const RecentTransactions = ({ transactionData,setViewAll ,decoded}) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm">
      <div className="flex justify-between items-center mb-3">
        ...
        <button onClick={()=>setViewAll(true)} className="text-sm cursor-pointer hover:bg-gray-200 h-8 w-18 rounded-lg font-medium text-gray-600 hover:text-black transition-colors duration-300">
          View All
        </button>
      </div>
