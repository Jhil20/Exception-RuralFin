...
import { ArrowRight, User, Phone, Mail, Calendar, MapPin, Lock } from 'lucide-react';
      ...
      >
        {({ isSubmitting, values }) => (
          <Form className="space-y-5">
            ...
            <button
              type="submit"
              className="mt-6 w-full px-4 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:bg-gray-400"
